...
namespace SuperNewRoles
{
    ...
    public static class RoleHelpers
    {
        ...
        public static void setRole(this PlayerControl player, RoleId role)
        {
            switch (role)
            {
                ...
                case (CustomRPC.RoleId.RemoteSheriff):
                    ...
                    break;
                case (CustomRPC.RoleId.Youtuber):
                    Roles.RoleClass.Youtuber.YoutuberPlayer.Add(player);
                    break;
                //ロールアド
                default:
        ...
        public static void ClearRole(this PlayerControl player)
        {
            ...
            switch (player.getRole())
            {
                ...
                case (CustomRPC.RoleId.RemoteSheriff):
                    ...
                    break;
                case (CustomRPC.RoleId.Youtuber):
                    Roles.RoleClass.Youtuber.YoutuberPlayer.RemoveAll(ClearRemove);
                    break;
                //ロールリモベ
        ...
        public static RoleId getRole(this PlayerControl player,bool IsChache = true)
        {
            ...
            else if (Roles.RoleClass.Youtuber.YoutuberPlayer.IsCheckListPlayerControl(player))
            {
                return CustomRPC.RoleId.Youtuber;
            }
            //ロールチェック
            }
            catch (Exception e)
